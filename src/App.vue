<template>
  <div id="app" class="flex flex-col min-h-screen">
        ...
        >
          <div class="flex flex-wrap -mx-4">
            <div class="md:w-1/2 px-4 md:pt-12">
              <heading tag="h1" size="heading" class="mb-6 md:pr-16"
    ...
    <div
      class="w-full max-w-screen-xl mx-auto sm:px-6 p-8 flex justify-between flex-wrap"
    >
      ...
      <div class="text-gray-600 text-sm">
        Powered By
        <link-to to="https://www.netlify.com/" target="_blank">Netlify</link-to
        >,
        <link-to to="https://heroku.com/" target="_blank">Heroku</link-to> &amp;
        <link-to to="https://github.com/" target="_blank">Github</link-to>
      </div>
      <!-- </div> -->
    </div>
  </div>
