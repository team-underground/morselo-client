				...
				<template v-slot="{ result: { error, data, loading }, query, isLoading }">
                  ...
                  params: {
                    category: tag
						...
						<h2 class="mb-4 inline-block leading-tight text-3xl sm:text-4xl md:text-5xl font-bold sans-serif-3 text-gray-800 tracking-tight">
							{{ data.bit.title }}
						</h2>

						<div class="md:flex md:-mx-6">
							<div class="md:w-2/3 md:px-6">
								<div class="md:flex md:flex-wrap text-normal items-center text-gray-600 leading-tight border-b mb-6  pb-4">
									<div class="md:w-1/2">
										By
										<a
											href="#"
                  ...
                  "
								...
								>
									<template v-slot="{ result: { loading, error, data } }">
										<div class="border-t pt-1 border-gray-800 mt-6 md:mt-32 lg:mt-64">
...
<style>
blockquote {
	@apply border-l-4 border-blue-400 mx-4 my-8 px-8;
}
blockquote {
...
.markdown-content h3,
.markdown-content h4 {
	@apply text-gray-900 font-bold leading-tight tracking-tight mb-2;
}
...
.markdown-content p,
.markdown-content ul {
	@apply text-gray-900 font-normal mb-4 leading-relaxed;
}
