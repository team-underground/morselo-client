			...
			<div class="flex flex-wrap -mx-4">
				<div class="md:w-1/2 px-4 md:pt-12">
					<heading
						tag="h1"
						size="display2"
						class="mb-6 md:pr-16 sans-serif-3"
					>Save snippets in one place</heading>
					<list
						:lists="lists"
					...
					>
						<a
							...
							class="inline-flex align-items-center justify-center font-semibold focus:outline-none focus:shadow-outline rounded-sm px-4 py-3 border border-gray-800 text-white bg-gray-800 mr-3 hover:opacity-75 shadow"
						>Login with Github</a>
						<!-- <loading-button
							tag="a"
							to="/"
